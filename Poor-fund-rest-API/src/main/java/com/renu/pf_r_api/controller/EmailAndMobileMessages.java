...
/*private static final String SID="ACbf152064a7cf9493abd5f5fe04b199e9";
private static final String TOKEN="e95ec5af2d6a70ecb054dfe32390e917";
*/
...
public ResponseEntity<?>sendMessage(@RequestBody MobileMessage mobileMessage){
	...
	Message message=Message.creator(new PhoneNumber(mobileMessage.getDestinationNumber()),new PhoneNumber(mobileMessage.getSourceNumber()), "Kmn aso ! gf kmn ase")
			.create();
